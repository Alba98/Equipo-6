...
public class CreacionJugador extends JDialog {
    ...
    public CreacionJugador() {
        ...
        CJPrincipal.registerKeyboardAction(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                onCancel();
            }
        ...
        buttonOK.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null,"Jugador/a creado");
                return;
            }
        });
    }
    ...
    public static void main(String[] args) {
        CreacionJugador dialog = new CreacionJugador();
        dialog.pack();
        dialog.setVisible(true);
        System.exit(0);
    }

    public JPanel getCJPrincipal() {
        return CJPrincipal;
    }

    public void setCJPrincipal(JPanel CJPrincipal) {
    ...
    public JLabel getNROL() {
        return NROL;
    }

    public void setNROL(JLabel NROL) {
        this.NROL = NROL;
    }
}
