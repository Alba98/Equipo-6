...
AS
	V_RESULTADO_COD_EQUIPO1 NUMBER(2);
	V_RESULTADO_COD_EQUIPO2 NUMBER(2);

BEGIN

IF 	V_RESULTADO_COD_EQUIPO1>V_RESULTADO_COD_EQUIPO2
THEN
		UPDATE EQUIPOS
		SET    PUNTACION=PUNTACION +1
		WHERE  COD_EQUIPO=(SELECT P.COD_EQUIPO1
				   		   FROM P PARTICIPA, E EQUIPOS
			   	   		   WHERE P.COD_EQUIPO1=E.COD_EQUIPO);
ELSE

	   UPDATE EQUIPOS
	   SET    PUNTACION=PUNTACION +1
	   WHERE  COD_EQUIPO=(SELECT P.COD_EQUIPO2
				  	 	  FROM P PARTICIPA, E EQUIPOS
			   	          WHERE P.COD_EQUIPO2=E.COD_EQUIPO);
