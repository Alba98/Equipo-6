...
PROCEDURE INSERT_CLASIFICACION(
	P_COD_TEMPORADA TEMPORADAS.COD_TEMPORADA%TYPE;
	P_COD_EQUIPO1 PARTICIPA.COD_EQUIPO1%TYPE;
	P_COD_EQUIPO2 PARTICIPA.COD_EQUIPO2%TYPE;
	/*Suponemos que en la tabla PARTIDOS tenemos guardado una columna PUNTUACION*/
	P_RESULTADO PARTIDOS.RESULTADO%TYPE
	P_PARTIDO_GANADOS EQUIPOS.PUNTUACION%TYPE;
);
